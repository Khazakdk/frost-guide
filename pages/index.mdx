---
type: page
title: 10.1 Breath of Sindragosa Guide for Frost Death Knights
date: 2023-10-08
---
...
Frost embellishments:
First I will hit the major embellishments and point out the ones worth paying attention to, then I will provide several strategies for spending your early sparks.
...
Elemental Lariat - Like last patch, this is only good to grab if you have max sockets.  Always sim yourself before crafting this one.
Shadowflame Armor Patch - Despite the nerf, it is still quite strong.  You will not need to replace it on patch day.  It still beats out the other embellishments in sims using mythic Aberrus gear.
Undulating Sporecloak - In 10.2 this becomes a very strong pick.  The vers buff has a high uptime, making Sporecloak a frequent contender for the best dps embellishment in the different profiles I ran.  This is an easy choice for the first craft.
Blue Silkin Lining - This one is a tough one to judge.  When the buff is up it provides by far more secondaries than the other embellishments.  However, we cannot be sure how consistent the uptime will be.  At this time I can say that even as low as 30-40% uptime is enough for this to beat other embellishments.
Allied Wristguard of Companionship - Solid all around pick, most consistent embellishment we have this go.  It's always up, as long you're withing 30 yards of your allies (and that should always be true), and is useful in any target count unlike the Shadowflame Armor Patch.
Allied Chestplate of Generosity - You may have seen this talked about, but it was nerfed during the PTR cycle.  It's performance is lackluster and it uses a slot you might need to make your 4 piece.  
Dreamtender's Charm - This is bad.  Being locked out for 30 seconds every time you drop below 70% stops this from seeing play.  
Unstable Frostfire Belt - Unfortunately just lags well behind the others.  Better than nothing, but not great.
Frostfire Legguards of Preparation - Strong pick for M+ mains.  Not recommended at all for raid.

With these accounted for, let's talk about what to do with early sparks.

Easy mode: Craft Undulating Sporecloak, then Allied Wristguard.  Use later sparks on low ilvl slots or jewelry.
You plan to one trick Breath of Sindragosa: Craft a weapon first (maybe throw Blue Silken Lining on and take Shadowflame off boots/belt), then Sporecloak, then Wristguard.  Weapon crafts are strong early, however it is a spark spent that will not benefit Unholy or 2H Frost builds.
You like to live on the edge:  Sporecloak first, then upgrade boots or belt depending on which is the bigger ilvl bump.  Put Blue Silken Lining on it.  You can still fallback to the Shadowflame Patch if you end up with poor BSL uptime, but eventually Allied Wristguard will be better than the patch and you'll be behind a spark.  

## Consumes
<a href="https://wowhead.com/item=191329">Iced Phial of Corrupting Rage</a>  is incredibly good for us.  Dropping this Phial would be **worse** than taking off a mythic item level weapon and replacing it with a normal item level weapon.  <a href="https://wowhead.com/item=194823">Buzzing Rune</a> for the temporary enchant.  Sim yourself for gems and enchants.  For Runeforges, take <a href="https://wowhead.com/spell=53344">Rune of the Fallen Crusader</a>  and <a href="https://wowhead.com/spell=326911">Rune of the Fallen Crusader</a>
